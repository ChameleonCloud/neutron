...
def load_interface_driver(conf, get_networks_callback=None,
    ...
    :param get_port_callback: A callback to get port information. This will be
                              passed as an additional keyword argument to the
                              interface driver.
    ...
    try:
        ...
        return loaded_class(
            conf, get_networks_callback=get_networks_callback,
